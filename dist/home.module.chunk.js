...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, starwarsService) {
        this.router = router;
    ...
    HomeComponent.prototype.searchType = function (query) {
        if (query === '') {
            this.initPeople();
        }
    };
    ...
    HomeComponent.prototype.onSubmit = function (form) {
        ...
        var person = new __WEBPACK_IMPORTED_MODULE_5__models_person__["a" /* Person */]().deserialize(form.value);
    ...
    HomeComponent.prototype.loadPage = function (url) {
        var _this = this;
        var pageNumber = this.starwarsService.getPageNumberFromUrl(url);
